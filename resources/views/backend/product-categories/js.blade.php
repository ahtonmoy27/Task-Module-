    ...
    <script>
        ...
        function loadProductCategories() {
            ...
            let callParams = {};
            callParams.url = "{{ route('product-categories.index') }}" + (gFilterObj ? '?' + $.param(gFilterObj) : '');
            callParams.type = "GET";
        ...
        $(document).on('click', '.itemAddBtn', function(e) {
            ...
            ajaxCall(callParams, function(result) {
                ...
                resetLoading('.itemAddBtn', 'Save All');
        ...
        $('body').on('click', '.addItemSideBarBtn', function() {
            ...
            $('form#offcanvasAddItemSideBar').attr('action', "{{ route('product-categories.store') }}");
        ...
        $('body').on('click', '.editItem', function() {
            ...
            let actionUrl = "{{ route('product-categories.edit', ['id' => ':id']) }}".replace(':id', itemId);
            ...
            $('form#itemAddForm').attr('action', "{{ route('product-categories.update', ['id' => ':id']) }}".replace(':id',
                itemId));

            let callParams = {};

            callParams.type = "GET";
            callParams.url = "{{ route('product-categories.edit', ['id' => ':id']) }}".replace(':id', itemId);
            callParams.data = "";
        ...
        $(document).on('click', '.deleteItem', function(e) {
            ...
            let callParams = {};
            callParams.url = "{{ route('product-categories.delete', ['id' => ':id']) }}".replace(':id', itemId);
